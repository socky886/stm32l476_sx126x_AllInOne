...
{
      printf("    //------sx126x---------------\n");
    printf("    SX126xSetTxContinuousWave();\n");
...
{
     printf("    //------sx126x---------------\n");
    printf("    SX126xSetTxInfinitePreamble();\n");
...
{
     printf("    //------sx126x---------------\n");
    printf("    SX126xSetStopRxTimerOnPreambleDetect();\n");
...
{
     printf("    //------sx126x---------------\n");
    printf("    SX126xSetLoRaSymbNumTimeout();\n");
...
{
     printf("    //------sx126x---------------\n");
    printf("    SX126xSetRxTxFallbackMode();\n");
...
{
     printf("    //------sx126x---------------\n");
    printf("    SX126xSetDio2AsRfSwitchCtrl();\n");
...
{
     printf("    //------sx126x---------------\n");
    printf("    SX126xSetDio3AsTcxoCtrl();\n");
    uint8_t buf[4];
...
{
     printf("    //------sx126x---------------\n");
    printf("    SX126xSetModulationParams();\n");
    uint8_t n;
    uint32_t tempVal = 0;
...
{
      printf("    //------sx126x---------------\n");
    printf("    SX126xSetBufferBaseAddress();\n");
    uint8_t buf[2];
...
{
     printf("    //------sx126x---------------\n");
    printf("    SX126xGetRxBufferStatus();\n");
    uint8_t status[2];
...
{
     printf("    //------sx126x---------------\n");
    printf("    SX126xClearDeviceErrors();\n");
...
{
    printf("    //------sx126x---------------\n");
    printf("    SX126xConvertFreqInHzToPllStep();\n");
    uint32_t stepsInt;
    uint32_t stepsFrac;
